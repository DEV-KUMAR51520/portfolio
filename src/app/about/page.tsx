...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "devk51520@gmail",
    href: "mailto:devk51520@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/dev-kumar-b64222255/",
    content: "/dev-kumar-b64222255/",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/DEV-KUMAR51520",
    content: "DEV-KUMAR51520",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Dev Kumar</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Dev Kumar, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and 
              Database management with hands-on experience in deploying & automating workflows, and 
              in working on distributed systems. Strong analytical skills,effective communication,
