...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className={cn("relative z-10 w-full h-screen pointer-events-none")}>
      <div className="grid md:grid-cols-2">
        <div
          className={cn(
            "h-[calc(100dvh-3rem)] md:h-[calc(100dvh-4rem)] z-[2]",
            "col-span-1 pointer-events-auto",
          ...
          {!isLoading && (
            <>
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://s3.ap-south-1.amazonaws.com/aws.dev.cloud/Dev_amazon_resume.pdf"
                  }
                  target="_blank"
                  className="flex-1"
                >
